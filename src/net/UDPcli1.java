...
public class UDPcli1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(".... Client 2nd Code Is Running ....");
        System.out.println("");
        System.out.println("-->> Client 2nd is sending packet...");
        System.out.println("");
        ...
        while (System.currentTimeMillis() - startTime < duration) {
            ...
            int capacity = 0;
            int site_on_going = (randomint % 3); // 0 for ALert & else for Safe !!
            if(site_on_going == 0) {
            ...
            sen.disp_lat(sen.latitude1);
            System.out.println();

            sen.disp_long(sen.longitude1);
            System.out.println();
            ...
            sen.disp_lattime(sen.latitude1);
            System.out.println();

            sen.disp_longtime(sen.longitude1);
            System.out.println();
            ...
            dataToSend.append(sen.latitude1).append(",");
            dataToSend.append(sen.longitude1).append(",");
